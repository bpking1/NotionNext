  ...
  return <>
    {post && <>
      <div className={(tocVisible ? 'animate__slideInRight' : ' -mr-72 animate__slideOutRight md:animate__slideInRight md:mr-0') +
        ' overflow-y-hidden shadow-card w-60 duration-200 fixed right-1 bottom-16 z-40 rounded py-2 bg-[#f8f3e9] dark:bg-gray-600 dark:text-gray-400 text-gray-600 h-56 md:h-96'}>
